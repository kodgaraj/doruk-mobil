    ...
    return (
      ...
      >
        <Button
          ...
          style={styles.buton}
          onPress={() => {
            getFormlar(formlar.formlar.prev_page_url);
          }}
        ...
        >
          <Text>
            {formlar.formlar.current_page}/{formlar.formlar.last_page}
          </Text>
        ...
        <Button
          ...
          style={styles.buton}
          onPress={() => {
            getFormlar(formlar.formlar.next_page_url);
          }}
